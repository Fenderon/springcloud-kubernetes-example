...
kubectl delete --ignore-not-found=true -f ${workdir}/server/src/main/resources/consumer-dev.yaml
kubectl apply -f ${workdir}/server/src/main/resources/consumer-dev.yaml
